      ...
      <footer className="text-center pb-4">
        ...
        <div className="text-colorLightBrown">
          ...
          <p className="text-sm m-0">
              ...
              </a> and styled with <a target="_blank" title="Tailwind CSS" rel="noopener" href="https://tailwindcss.com/">
          ...
          <p className="text-[10px] m-0" ><small>Latest update: 28 Sept 2024</small></p>
        </div>
      </footer>
    </>
  );
